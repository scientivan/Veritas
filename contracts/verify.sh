...
LAUNCH_REGISTRY=0x9dF98317b07B2964c25b45a934a0f9DAAB50aea2
...
LAUNCH_REGISTRY_ARGS=$(cast abi-encode 'constructor(address)' $REGISTRY)
...
verify() { # <addr> <contract> <args>
  ...
  forge verify-contract "$addr" "$contract" \
    ...
    --constructor-args "$args" 2>&1 | tail -5
  echo "---"
}
...
verify $LAUNCH_REGISTRY src/IPLaunchRegistry.sol:IPLaunchRegistry                  "$LAUNCH_REGISTRY_ARGS"
